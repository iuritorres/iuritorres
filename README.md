...
[![My Skills](https://skillicons.dev/icons?i=linux,aws,gcp,docker,nextjs,react,nodejs,ts,java,spring,tailwind,sass,py,django,git,gitlab,github,bitbucket,githubactions,firebase,mysql,figma,webpack,wordpress,discordjs)](https://skillicons.dev)
